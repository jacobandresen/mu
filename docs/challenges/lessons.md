# Challenge lessons — knowledge base

Machine-maintained knowledge base of recurring dojo failures. `mu reflect` appends a
distilled, generic lesson here after each round; `enrich.py` embeds the `## Open`

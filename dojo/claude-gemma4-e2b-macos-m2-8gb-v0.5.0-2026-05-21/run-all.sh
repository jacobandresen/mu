#!/bin/zsh
# Run all 7 dojo problems for session (2026-05-21, gemma4:e2b).
# Execute from the repo root: dojo/claude-gemma4-e2b-macos-m2-8gb-v0.5.0-2026-05-21/run-all.sh

REPO="$(cd "$(dirname "$0")/../.." && pwd)"
SESSION="claude-gemma4-e2b-macos-m2-8gb-v0.5.0-2026-05-21"

#!/bin/zsh
# Run all 7 dojo problems — iteration 5 (2026-05-21, gemma4:e2b, +FixOrphanTopLevelCommands+tool-path-logging).
# Execute from the repo root: dojo/claude-gemma4-e2b-macos-m2-8gb-v0.5.0-2026-05-21-E/run-all.sh

REPO="$(cd "$(dirname "$0")/../.." && pwd)"
SESSION="claude-gemma4-e2b-macos-m2-8gb-v0.5.0-2026-05-21-E"
RUN="$REPO/dojo/run.sh"

export MU_AGENT_BASE_MODEL=gemma4:e2b

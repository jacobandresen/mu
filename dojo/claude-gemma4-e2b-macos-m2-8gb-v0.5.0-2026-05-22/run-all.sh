#!/bin/zsh
# Run all 7 dojo problems for gemma4:e2b run 7 (2026-05-22).
# Execute from the repo root: dojo/claude-gemma4-e2b-macos-m2-8gb-v0.5.0-2026-05-22/run-all.sh

REPO="$(cd "$(dirname "$0")/../.." && pwd)"
SESSION="claude-gemma4-e2b-macos-m2-8gb-v0.5.0-2026-05-22"

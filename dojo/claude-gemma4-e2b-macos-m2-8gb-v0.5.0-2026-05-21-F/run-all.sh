#!/bin/zsh
# Run all 7 dojo problems — iteration 6 (2026-05-22, gemma4:e2b, +WriterToolDefs+SDL2InlineFix).
# Execute from the repo root: dojo/claude-gemma4-e2b-macos-m2-8gb-v0.5.0-2026-05-21-F/run-all.sh

REPO="$(cd "$(dirname "$0")/../.." && pwd)"
SESSION="claude-gemma4-e2b-macos-m2-8gb-v0.5.0-2026-05-21-F"

...
# Honest harness: general sensors only (Makefile syntax, Python syntax).
# MU_AGENT_MODEL left unset — auto-detected from single loaded model.
#
# Execute from the repo root:
#   dojo/claude-qwen25coder-7b-lmstudio-v0.7.0-2026-05-23-B/run-all.sh

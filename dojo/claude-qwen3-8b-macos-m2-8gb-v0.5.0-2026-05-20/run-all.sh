#!/bin/zsh
# Run all 7 dojo problems for session H (2026-05-20).
# Execute from the repo root: dojo/claude-qwen3-8b-macos-m2-8gb-v0.5.0-2026-05-20/run-all.sh

REPO="$(cd "$(dirname "$0")/../.." && pwd)"
SESSION="claude-qwen3-8b-macos-m2-8gb-v0.5.0-2026-05-20"

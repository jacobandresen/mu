...
Outcomes are stochastic (a weak model varies run to run). The table below shows the **measured** result of the most recent `mu dojo practice` round (auto-updated at the end of every round). Each problem links to its page in `docs/` with the problem statement, what it builds, its major challenges, and the reflexes that carry it.

<!-- DOJO-RESULTS:START (auto-generated by mu.dojo — do not edit by hand) -->
_Last round: 2026-06-12T18:19:50+02:00 · model: lmstudio-community/qwen2.5-coder-7b-instruct_

| Problem | Solved in last round |
|---|---|
| [p1-helloworld](docs/p1-helloworld.md) | — (not run) |
| [p2-sqlite](docs/p2-sqlite.md) | — (not run) |
| [p3-sdl2](docs/p3-sdl2.md) | — (not run) |
| [p4-fibonacci](docs/p4-fibonacci.md) | — (not run) |
| [p5-gin](docs/p5-gin.md) | PASS |
| [p6-rust](docs/p6-rust.md) | — (not run) |
| [p7-flask](docs/p7-flask.md) | — (not run) |
| [p8-node-todo](docs/p8-node-todo.md) | — (not run) |
| [p9-vue-todo](docs/p9-vue-todo.md) | — (not run) |
| [p10-dotnet-vue-blog](docs/p10-dotnet-vue-blog.md) | UNKNOWN |
<!-- DOJO-RESULTS:END -->

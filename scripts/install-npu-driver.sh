...
echo "     Expected: ['CPU', 'GPU', 'NPU']"
echo "  3. Set up mu with OpenVINO Mistral:"
echo "       make deps               # installs packages + downloads model"
echo "       mu model load \$(python3 -c \"from mu.client import load_backend; print(load_backend().get('model',''))\") --backend openvino --device NPU"
echo "  4. Run the agent:"
echo "       mu agent \"your goal\""
